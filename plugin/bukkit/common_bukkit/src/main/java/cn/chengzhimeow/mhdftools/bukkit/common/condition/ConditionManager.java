...
import cn.chengzhimeow.mhdftools.bukkit.common.condition.pre.PagePreProcess;
import cn.chengzhimeow.mhdftools.bukkit.common.condition.pre.StringPlaceholderPreProcess;
...
public final class ConditionManager {
    ...
    private ConditionManager() {
        ...
        this.ccCondition.getPreProcessRegistry().register(String.class, new StringPlaceholderPreProcess());
