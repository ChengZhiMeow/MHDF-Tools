...
public final class LangSetting extends AbstractLangSetting<LangSetting.Config> {
    ...
    public void reload() {
        ...
        this.config = new Config(
                new Config.Commands(
                        new Config.Commands.Broadcast(
                                super.component("commands.broadcast.usage", prefix),
                                super.component("commands.broadcast.description", prefix),
                                super.component("commands.broadcast.format", prefix),
                                super.component("commands.broadcast.message", prefix)
                        )
                )
        );
    }
