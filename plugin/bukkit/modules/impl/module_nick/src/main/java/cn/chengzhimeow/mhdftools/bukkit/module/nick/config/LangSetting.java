package cn.chengzhimeow.mhdftools.bukkit.module.nick.config;
...
public final class LangSetting extends AbstractLangSetting<LangSetting.Config> {
    ...
    public void reload() {
        ...
        this.config = new Config(
                new Config.Commands(
                        new Config.Commands.Nick(
                                super.component("commands.nick.usage", prefix),
                                super.component("commands.nick.description", prefix),
                                super.component("commands.nick.message", prefix)
                        )
                )
        );
    }
