...
public final class ChatBroadcastMessage implements RedisMessage {
    ...
    public ChatBroadcastMessage(String sourceServer, String sender, String miniMessage, List<String> atList, List<byte[]> cacheDataList) {
    ...
    public void handle(MessageBroker broker) {
        ...
        Bukkit.getConsoleSender().sendMessage(ColorUtil.color(this.miniMessage));
    }
