...
public final class LangSetting extends AbstractLangSetting<LangSetting.Config> {
    ...
    public void reload() {
        ...
        this.config = new Config(
                new Config.Commands(
                        new Config.Commands.FastChangeTime(
                                super.component("commands.fastchangetime.usage", prefix),
                                super.component("commands.fastchangetime.description", prefix),
                                super.component("commands.fastchangetime.message", prefix)
                        )
                )
        );
    }
    ...
    public record Config(
        ...
        public record Commands(
                FastChangeTime fastChangeTime
        ) {
            public record FastChangeTime(
                    TextComponent usage,
