package cn.chengzhimeow.mhdftools.bukkit.module.tpahere.cache;
...
public final class RequestCache {
    ...
    public void init() {
        this.cache = MHDFToolsBukkit.getInstance().getCacheManager().createCache("module:tpahere:request", String.class);
        this.cache.init();
    }
