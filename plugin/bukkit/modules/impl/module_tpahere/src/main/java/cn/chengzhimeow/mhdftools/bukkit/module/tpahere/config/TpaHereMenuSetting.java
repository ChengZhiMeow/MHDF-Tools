...
public final class TpaHereMenuSetting extends AbstractYamlSetting<TpaHereMenuSetting.Config> {
    @Getter(lazy = true)
    private static final TpaHereMenuSetting instance = new TpaHereMenuSetting();
    @Getter private Config config;

    private TpaHereMenuSetting() {
    }

    @Override
    public String originFilePath() {
        return "module/" + ModuleMain.instance.getId() + "/menu/tpahere.yml";
    }
