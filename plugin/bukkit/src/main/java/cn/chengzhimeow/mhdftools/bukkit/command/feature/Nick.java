...
final class Nick extends Command {
    public Nick() {
        super(
                ...
                false,
                ConfigSetting.getInstance().getData().getStringList("nickSettings.commands").toArray(new String[0])
        );
    }
    ...
    public void execute(@NotNull CommandSender sender, @NotNull String label, @NotNull String[] args) {
        ...
        if (player == null) {
            sender.sendMessage(LangSetting.getInstance().i18n("usageError")
                    .replace("{usage}", LangSetting.getInstance().i18n("commands.nick.usage"))
        ...
        sender.sendMessage(LangSetting.getInstance().i18n("commands.nick.message")
