package cn.chengzhimeow.mhdftools.bukkit.manager.redis;
...
public final class RedisClient {
    ...
    public void connect() {
        ...
        this.redisMessageManager = new RedisMessageManager(this.getServerId() + "mhdftools-message-", this.redisClient.connectPubSub());
    }
