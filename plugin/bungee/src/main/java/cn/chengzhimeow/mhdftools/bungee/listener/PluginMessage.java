package cn.chengzhimeow.mhdftools.bungee.listener;

import cn.chengzhimeow.mhdftools.bungee.Main;
...
public final class PluginMessage implements Listener {
    ...
    public void onPluginMessage(PluginMessageEvent event) {
        ...
        ServerInfo senderServer = this.getServerInfo(event);
        ...
        switch (action) {
            ...
            default -> {
                ...
                switch (to) {
                    ...
                    case "me" -> this.sendData(senderServer, out);
                    default -> {
