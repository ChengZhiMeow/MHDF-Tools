...
public final class TeleportUtil {
    ...
    public static void teleport(Player player, Location location, ConcurrentHashMap<String, Integer> map) {
        ...
        player.teleportAsync(location).thenAccept(success -> {
            ...
            int maxTimes = Main.instance.getConfigManager().getConfigManager().getData().getInt("bungeecord.autoTry.maxTimes");
            ...
            int delay = Main.instance.getConfigManager().getConfigManager().getData().getInt("bungeecord.autoTry.delay");
