...
final class Money extends AbstractCommand {
    public Money() {
        super(
                ...
                false,
                Main.instance.getConfigManager().getConfigManager().getData().getStringList("economySettings.moneyCommands").toArray(new String[0])
        );
    }
    ...
    public void execute(@NotNull CommandSender sender, @NotNull String label, @NotNull String[] args) {
        ...
        if (player == null) {
            ActionUtil.sendMessage(sender, Main.instance.getConfigManager().getLangManager().i18n("usageError")
                    .replace("{usage}", Main.instance.getConfigManager().getLangManager().i18n("commands.money.usage"))
        ...
        ActionUtil.sendMessage(sender, Main.instance.getConfigManager().getLangManager().i18n("commands.money.message")
