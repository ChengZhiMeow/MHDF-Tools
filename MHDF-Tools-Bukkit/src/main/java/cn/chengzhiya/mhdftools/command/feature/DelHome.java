...
final class DelHome extends AbstractCommand {
    public DelHome() {
        super(
                ...
                true,
                Main.instance.getConfigManager().getConfigManager().getData().getStringList("homeSettings.delhomeCommands").toArray(new String[0])
        );
    }
    ...
    public void execute(@NotNull Player sender, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length != 1) {
            ActionUtil.sendMessage(sender, Main.instance.getConfigManager().getLangManager().i18n("usageError")
                    .replace("{usage}", Main.instance.getConfigManager().getLangManager().i18n("commands.delhome.usage"))
        ...
        ActionUtil.sendMessage(sender, Main.instance.getConfigManager().getLangManager().i18n("commands.delhome.message")
                .replace("{home}", args[0])
        );
    }
